...
{
	ui->setupUi(this);
	gGlobalConfig.setupCBPerfilesUsables( ui->cbPerfil, sd.perfilOriginal().isEmpty() ? gGlobalConfig.clientProfileList().defaultProfile().profileName() : sd.perfilOriginal() );
